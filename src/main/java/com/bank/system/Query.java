...
public class Query {
    ...
    // public static String checkAccountNumber = "SELECT * FROM accounts WHERE
    // account_number = ? OR email =
    ...
    public static String creditMoney = "UPDATE accounts SET balance = balance + ? WHERE account_number = ?";
    public static String transferMoney = "UPDATE accounts SET balance = balance - ? WHERE account_number = ?";
    public static String checkBalance = "SELECT balance FROM accounts WHERE account_number = ?";
}
